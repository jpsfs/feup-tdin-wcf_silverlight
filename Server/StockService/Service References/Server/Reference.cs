...
namespace StockService.Server {
    ...
    public partial class ClientInfo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private StockService.Server.ClientRole RoleField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public StockService.Server.ClientRole Role {
            get {
    ...
    public partial class Transaction : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private StockService.Server.TransactionState StateField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private StockService.Server.TransactionType TypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public StockService.Server.TransactionState State {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public StockService.Server.TransactionType Type {
            get {
    ...
    public interface IServiceTcp {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(StockService.Server.LoginException), Action="http://tempuri.org/IServiceTcp/DoWorkLoginExceptionFault", Name="LoginException", Namespace="http://schemas.datacontract.org/2004/07/Server.Exceptions")]
        string DoWork();
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(StockService.Server.GenericException), Action="http://tempuri.org/IServiceTcp/RegisterGenericExceptionFault", Name="GenericException", Namespace="http://schemas.datacontract.org/2004/07/Server.Exceptions")]
        ...
        StockService.Server.ClientInfo GetSession(string username);
        ...
        void NewTransaction(StockService.Server.TransactionType Type, double Quantity, string StockType);
        ...
        void NewTransactionBalcon(string ClientEmail, StockService.Server.TransactionType Type, double Quantity, string StockType);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(StockService.Server.GenericException), Action="http://tempuri.org/IServiceTcp/PerformTransactionGenericExceptionFault", Name="GenericException", Namespace="http://schemas.datacontract.org/2004/07/Server.Exceptions")]
        [System.ServiceModel.FaultContractAttribute(typeof(StockService.Server.PermissionDeniedException), Action="http://tempuri.org/IServiceTcp/PerformTransactionPermissionDeniedExceptionFault", Name="PermissionDeniedException", Namespace="http://schemas.datacontract.org/2004/07/Server.Exceptions")]
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(StockService.Server.GenericException), Action="http://tempuri.org/IServiceTcp/ListTransactionGenericExceptionFault", Name="GenericException", Namespace="http://schemas.datacontract.org/2004/07/Server.Exceptions")]
        [System.ServiceModel.FaultContractAttribute(typeof(StockService.Server.PermissionDeniedException), Action="http://tempuri.org/IServiceTcp/ListTransactionPermissionDeniedExceptionFault", Name="PermissionDeniedException", Namespace="http://schemas.datacontract.org/2004/07/Server.Exceptions")]
        StockService.Server.Transaction[] ListTransaction();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceTcpChannel : StockService.Server.IServiceTcp, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceTcpClient : System.ServiceModel.ClientBase<StockService.Server.IServiceTcp>, StockService.Server.IServiceTcp {
        ...
        public StockService.Server.ClientInfo GetSession(string username) {
            return base.Channel.GetSession(username);
        }
        
        public void NewTransaction(StockService.Server.TransactionType Type, double Quantity, string StockType) {
            base.Channel.NewTransaction(Type, Quantity, StockType);
        }
        
        public void NewTransactionBalcon(string ClientEmail, StockService.Server.TransactionType Type, double Quantity, string StockType) {
        ...
        public StockService.Server.Transaction[] ListTransaction() {
