...
namespace ClientApplication.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("ClientApplication-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/ClientApplication.Web")]
    public sealed partial class RegistrationData : ComplexObject
    {
        ...
        [Required(ErrorMessageResourceName="ValidationErrorRequiredField", ErrorMessageResourceType=typeof(ValidationErrorResources))]
        [StringLength(49, ErrorMessageResourceName="ValidationErrorBadUserNameLength", ErrorMessageResourceType=typeof(ValidationErrorResources), MinimumLength=4)]
        ...
        public string Session
        {
            ...
            set
            {
                if ((this._session != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Session");
                    this.ValidateProperty("Session", value);
                    this._session = value;
                    this.RaiseDataMemberChanged("Session");
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("ClientApplication-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
