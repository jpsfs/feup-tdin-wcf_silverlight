namespace ClientApplication
{
    ...
    public partial class App : Application
    {
        ...
        {
            ClientApplication.Controls.BusyIndicator busyIndicator = new ClientApplication.Controls.BusyIndicator();
        ...
        public static DataGridTextColumn CreateTextColumn(string fieldName, string title)
        {
